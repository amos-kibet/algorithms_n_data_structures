...
class linked_list:
    ...
    def add(self, data):
        """
        Adds new Node containing data at head of the link
        Takes O(1) time
        :param data:
        :return:
        """
    ...
    def search(self, key):
        """
        Search for the first node containing data that matcges key
    ...
    def insert(self, data, index):
        ...
        Insert takes O(1) time but finding the node at the
